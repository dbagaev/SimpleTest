...
#include <SimpleTest++/ReportAssert.h>
#include <SimpleTest++/TestList.h>
#include <SimpleTest++/TimeHelpers.h>
#include <SimpleTest++/TimeConstraint.h>
...
TEST_FIXTURE(TestRunnerFixture, SlowTestWithTimeExemptionPasses)
{
    ...
    public:
        ...
        virtual void RunImpl(TestResults&) const
        {
            SIMPLETEST_TIME_CONSTRAINT_EXEMPT();
            TimeHelpers::SleepMs(20);
        }
    };
