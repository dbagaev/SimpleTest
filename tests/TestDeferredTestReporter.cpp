...
#include <SimpleTest++/DeferredTestReporter.h>
#include <SimpleTest++/Config.h>              
...
#ifdef SIMPLETEST_USE_CUSTOM_STREAMS
...
TEST_FIXTURE(DeferredTestReporterFixture, DeferredTestReporterTakesCopyOfFailureMessage)
{
    ...
    strcpy_s(failureMessage, 128, goodStr);
    reporter.ReportFailure(details, failureMessage);
    strcpy_s(failureMessage, 128, badStr);
